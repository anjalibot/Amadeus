...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5666023868:AAFQIUJfnRg_vrHegoEziKBlBpnwyDxaCWA"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Ai Based Bot'
username = 'heavy_developer_bot'
